...
from keyboards.inline.menu_keyboards.menu_buttoms import epic_sub_settings_buttom, epic_cancel_settings_buttom,\
                                                  menu_editmsg_buttom
...
async def show_sources(call: types.CallbackQuery):
    ...
    await call.message.edit_text("Настройки бота", reply_markup=settings_keyboard)
